 ...
 * @author ioapau
 */
public class RaportStocuriDetaliatWindow extends JPanel {
    
    private StocManagementMain controller = null;
    
    
    public RaportStocuriDetaliatWindow() {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT t FROM Vstoctotal t");
        ...
        controller.computeStocTotal(list);
    ...
    private class FormListener implements java.awt.event.ActionListener, javax.swing.event.AncestorListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == jButton1) {
                RaportStocuriDetaliatWindow.this.jButton1ActionPerformed(evt);
            }
            else if (evt.getSource() == jCbxCategorii) {
                RaportStocuriDetaliatWindow.this.jCbxCategoriiActionPerformed(evt);
            }
            else if (evt.getSource() == jButton2) {
                RaportStocuriDetaliatWindow.this.jButton2ActionPerformed(evt);
            }
        }

        public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
            if (evt.getSource() == RaportStocuriDetaliatWindow.this) {
                RaportStocuriDetaliatWindow.this.formAncestorAdded(evt);
            }
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        this.query = Filter.getRaportStocuriTotalQuery(entityManager, jCbxCategorii, jCbxProduse, jtxtData1, jtxtData2);
